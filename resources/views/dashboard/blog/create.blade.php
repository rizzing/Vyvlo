                ...
                <div class="col-sm-12">
                    <div class="element-wrapper">
                        <div class="element-box">
                            ...
                            <form method="post" action="{{ route('blog.create_item') }}" enctype="multipart/form-data">
                                <div class="row">
                                    {{ csrf_field() }}
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-error has-danger' : '' }}">
                                            <label for="">Title</label><input required value="{{old('title')}}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group{{ $errors->has('author') ? ' has-error has-danger' : '' }}">
                                            <label for="">Author</label><input required value="{{old('author')}}"
                                                                              name="author" class="form-control" placeholder="Author" type="text">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group{{ $errors->has('date') ? ' has-error has-danger' : '' }}">
                                            ...
                                            <div class="date-input">
                                                <input value="{{old('date')}}" name="date" class="form-control single-daterange" placeholder="Date" type="text">
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('description') ? ' has-error has-danger' : '' }}">
                                            ...
                                            <textarea id="description" required class="form-control" name="description" rows="10" placeholder="Description">{{old('description')}}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('video') ? ' has-error has-danger' : '' }}">
                                            <label for="">Video</label><input value="{{old('video')}}"
